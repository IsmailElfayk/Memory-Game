...
var checkedSound = new Audio("../audio/correct-choice-43861.mp3");
var errorSound = new Audio("../audio/error-126627.mp3");
var successSound = new Audio("../audio/success-fanfare-trumpets-6185.mp3");
